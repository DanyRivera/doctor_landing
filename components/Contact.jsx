...
const Contact = () => {
    return (
        <Element name="contacto">
            <section className="mt-12 md:mt-0 mb-0 py-18  relative md:mx-0 bg-secondary">
                <div className=" flex flex-col gap-4  contenedor">
                    <motion.h2 initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.8}} className="text-center font-bold text-2xl uppercase ">Contactanos</motion.h2>
                    <motion.p initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.8}} className="text-center mx-5 text-gray-500 md:w-1/2 md:mx-auto">Sientete libre en contactarnos si tienes algun problema o situación!</motion.p>
                    ...
                    <div className="mt-10 flex flex-col gap-10 md:flex-row md:grid md:grid-cols-5">
                        <div className="flex flex-col gap-5 justify-center items-center md:col-span-3">
                            ...
                            <form className="w-full px-12 flex flex-col gap-5">
                                <motion.div initial={{opacity: 0, y:50}} whileInView={{opacity: 1, y:0}} transition={{duration: 0.5}} viewport={{once: true}} className="flex flex-col gap-2 ">
                                ...
                                <motion.div initial={{opacity: 0, y:75}} whileInView={{opacity: 1, y:0}} transition={{duration: 0.5}} viewport={{once: true}} className="flex flex-col gap-2 ">
                                ...
                                <motion.div initial={{opacity: 0, y:100}} whileInView={{opacity: 1, y:0}} transition={{duration: 0.5}} viewport={{once: true}} className="flex flex-col gap-2 ">
                                ...
                                <motion.input initial={{opacity: 0, y:125}} whileInView={{opacity: 1, y:0}} transition={{duration: 0.5}} viewport={{once: true}} type="submit" className="bg-primary text-white py-3 md:py-5 rounded-full text-center mt-5" value="Enviar Mensaje" />
                            </form>
                        </div>
                        <div className="flex flex-col gap-5 justify-center items-center md:col-span-2">
                            ...
                            <div className="flex flex-col gap-14 mt-5 px-16">
                                <div className="flex gap-5 items-center">
                                    <motion.div initial={{opacity: 0, x:10}} whileInView={{opacity: 1, x:0}} transition={{duration: 0.8}} className="bg-white p-3 rounded-full">
                                    ...
                                    <motion.div initial={{opacity: 0, x:20}} whileInView={{opacity: 1, x:0}} transition={{duration: 0.8}} className="flex flex-col gap-2">
