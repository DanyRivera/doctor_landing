        ...
        <Element name="servicios">
            <section className="bg-secondary mt-20 mb-14 py-18 relative">
                <div className="contenedor flex flex-col gap-4">
                    <motion.h2 initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.8}} className="text-center font-bold text-2xl uppercase">Servicios</motion.h2>
                    <motion.p initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.8}} className="text-center mx-5 text-gray-500 md:w-1/2 md:mx-auto">En esta sección encontrarás los servicios médicos que el Dr. Daniel Rivera pone a tu disposición, diseñados para ofrecer atención integral y de calidad.</motion.p>
                    <div className="flex flex-col gap-10 mt-5 md:grid md:grid-cols-4 ">
                        <motion.div initial={{opacity: 0, x: -200}} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.8}} viewport={{once:true}}  className="bg-white mx-10 p-5 flex flex-col gap-3 rounded-xl shadow-xl md:mx-0">
                        ...
                        <motion.div initial={{opacity: 0, x: -100}} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.8}} viewport={{once:true}} className="bg-white mx-10 p-5 flex flex-col gap-3 rounded-xl shadow-xl md:mx-0">
