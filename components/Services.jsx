            ...
            <section className="bg-secondary mt-20 mb-14 py-18 relative">
                <div className="contenedor flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-10 mt-5 md:grid md:grid-cols-4 ">
                        <motion.div initial={{opacity: 0, x: -200}} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.8}}  className="bg-white mx-10 p-5 flex flex-col gap-3 rounded-xl shadow-xl md:mx-0">
                        ...
                        <motion.div initial={{opacity: 0, x: -100}} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.8}} className="bg-white mx-10 p-5 flex flex-col gap-3 rounded-xl shadow-xl md:mx-0">
