        ...
        <Element name="experiencia">
            <section className="my-12 md:mt-12 md:mb-80 py-18 ">
                <div className=" flex flex-col gap-4 md:relative md:mx-52 md:h-96">
                    <motion.h2 initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.8}} className="text-center font-bold text-2xl uppercase ">Habilidades y Experiencia</motion.h2>
                    ...
                    <div className="flex flex-col gap-20 items-center mt-10 md:grid md:grid-cols-9 md:gap-40">
                        ...
                        <div className="relative w-full h-96 md:col-start-4 md:col-end-7">
                            ...
                            <motion.div initial={{opacity: 0, y: 50}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.8}} className="bg-primary flex items-center gap-2 absolute p-4 rounded-2xl -top-2 left-3 md:-left-18 md:top-0">
