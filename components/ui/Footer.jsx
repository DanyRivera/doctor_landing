...
const Footer = () => {
    return (
        <footer className="bg-primary text-white p-5">
            <div className="contenedor md:flex md:justify-between md:pt-12">
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-xl">Contactanos hoy y agenda una consulta con uno de nuestros médicos. <br /> El camino a una visa saludable comienza aquí.</p>
                </div>
            ...
            <div className="flex justify-center pb-5 gap-5 md:mt-10">
